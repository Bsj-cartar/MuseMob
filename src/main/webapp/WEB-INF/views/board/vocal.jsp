		...
		<div class="row">
			...
			<c:forEach var="musemob" items="${musemobs}">
				<div class="slides_content_left col-6 col-12-small">
					...
					<a href="vocal/${musemob.musemobid }/chapmchoice" class="chapmchoice button small">응원하기</a>
				...
				<div class="slides_content_right col-6 col-12-small">
					...
					<a href="vocal/${musemob.musemobid }/challchoice" class="challchoice button small">응원하기</a>
				</div>
			</c:forEach>
					...
					<section>
						<div class="content">
							...
							<ul class="actions">
								...
								<li><a href="vocal/${list.postid}/support" class="button small">후원하기</a>
